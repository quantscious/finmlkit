...
from finmlkit.structural_breaks.cusum import cusum_developing, cusum_last, cusum_rolling
...
def test_chu_stinchcombe_white_developing_basic():
    ...
    y = np.arange(1, 101)
    s_n_t_values_up, s_n_t_values_down, critical_values_up, critical_values_down = cusum_developing(
        y, warmup_period=10
    )
...
def test_chu_stinchcombe_white_developing_constant_series():
    ...
    y = np.ones(100)
    s_n_t_values_up, s_n_t_values_down, critical_values_up, critical_values_down = cusum_developing(y)
...
def test_chu_stinchcombe_white_developing_random_walk():
    ...
    s_n_t_values_up, s_n_t_values_down, critical_values_up, critical_values_down = cusum_developing(S)
...
def test_chu_stinchcombe_white_last():
    ...
    y = np.arange(1, 101)
    s_n_t_up, s_n_t_down, c_value_up, c_value_down = cusum_last(y)
...
def test_chu_stinchcombe_white_rolling():
    ...
    y = np.arange(1, 2000)
    snt_up, snt_down, critical_values_up, critical_values_down = cusum_rolling(
