...
echo "⚠️  JIT compilation disabled globally. It will be enabled for each individual test run."

# Run tests with coverage from project root
echo "🧪 Running tests..."
pytest --jit tests/ --cov=finmlkit --cov-report=xml --cov-report=term -v
